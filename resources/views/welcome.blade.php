...
?>  
  <body>
                    ...
                    <tr>
                        <td>Merchant Transaction ID: *</td><td><input type="hidden" name="tran_id" value="WEP-<?php echo "$cur_random_value"; ?>">WEP-<?php echo "$cur_random_value"; ?></td>
                    </tr>

                    <tr>
                        <td>Pay Amount *</td><td><input type="text" name="amount" value="20"> Taka</td>
                    </tr>
                    
                    <input type="text" name="currency" value="BDT">
                    
                    <tr><td>Customer Name: *</td><td><input type="text" name="cus_name" value="nitu"></td></tr>

                    <tr><td>Customer Email Address: *</td><td><input type="text" name="cus_email" value="nafisanitu240@gmail.com"></td></tr>

                    <tr><td>Customer Address Line 1: </td><td><input type="text" name="cus_add1" value="Mdpur"></td></tr>

                    <tr><td>Customer Address Line 2: </td><td><input type="text" name="cus_add2" value="Mdpur"></td></tr>
                    ...
                    <tr><td>Customer Phone: </td><td><input type="text" name="cus_phone" value="01968944208"></td></tr>

                    <tr><td>Customer Fax: </td><td><input type="text" name="cus_fax" value="989090"></td></tr>
                    ...
                    <tr><td>Product Description: </td><td><input type="text" name="desc" value="I have send money"></td></tr>
